...
set_name()
{
read -p "Please enter the host name: " hns
hostnamectl --static set-hostname $hns
}
...
repo_update(){
     ...
     yum -y install tmux vim openssh-clients iftop iotop sysstat lsof telnet traceroute tree man net-tools dstat ntpdate
     [ $? -eq 0 ] && echo "System upgrade && install pakeages complete."
